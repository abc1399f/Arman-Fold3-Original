...
data_dir = os.path.join( '/content/Arman-Fold3-Original/data/Arman-Fold3-Original/')
...
output_dir = '/content/Arman-Fold3-Original/output/'
...
def report(y_true, y_pred):
    '''
    list= [  '[CLS]', '[SEP]', 'O', 'I-loc', 'B-pers', 'I-pers', 'I-org', 'I-pro', 'B-pro','I-fac','B-fac', 'B-loc', 'B-org', 'B-event', 'I-event']
    '''
